...
public class EditProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Raw pet: " + request.getParameter("pet"));
            ...
            System.out.println("Converted pet: " + petID);
            ...
            Product updatedProduct = new Product(productID, productName, price, description, cateID, petID, imageURL, discount, stock);
            ProductDAO productDAO = new ProductDAO();
