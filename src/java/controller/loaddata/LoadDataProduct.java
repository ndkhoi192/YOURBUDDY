...
public class LoadDataProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("petParams: " + pet);
        ...
        for (Product product : productList) {
            ...
            boolean matchesPet = true;
            if (pet != null && !pet.isEmpty()) {
                if (product.getPetID() != Integer.parseInt(pet.trim())) {
                    matchesPet = false;
                }
            }
            ...
            if (matchesSearchName && matchesCategory && matchesPet && matchesStock) {
