                    ...
                    <aside class="recipes-sidebar">
                        <form action="ListProduct" method="GET"> <%-- COMBINED FILTER FORM --%>
                            ...
                            <div class="filter-group">
                                ...
                                <div class="filter-options">
                                    <ul>
                                        <li><label><input type="checkbox" name="category" value="1" ${fn:contains(paramValues.category, '1') ? 'checked' : ''}> Thức ăn</label></li>
                                        ...
                                        <li><label><input type="checkbox" name="category" value="4" ${fn:contains(paramValues.category, '4') ? 'checked' : ''}> Chăm sóc pet</label></li>
                            ...
                            <div class="filter-group">
                                ...
                                <div class="filter-options">
                                    <ul>
                                        <li><label><input type="checkbox" name="pet" value="1" ${fn:contains(paramValues.pet, '1') ? 'checked' : ''}> Chó</label></li>
                                        <li><label><input type="checkbox" name="pet" value="2" ${fn:contains(paramValues.pet, '2') ? 'checked' : ''}> Mèo</label></li>
                                        <li><label><input type="checkbox" name="pet" value="3" ${fn:contains(paramValues.pet, '3') ? 'checked' : ''}> Khác</label></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="pagination">
                    <c:forEach begin="1" end="${sessionScope.numpage}" var="i">
                        <a class="${i == sessionScope.page ? 'active' : ''}"
                           ...
                           <c:if test="${not empty sessionScope.petParams}">
                               <c:forEach var="petParam" items="${sessionScope.petParams}">
                                   &pet=${petParam}
                               </c:forEach>
                           </c:if>
