...
<%
    ...
    List<Product> similarProducts = productDAO.getSimilarProducts(product.getCateID(), product.getPetID(), product.getProductID(), 4); // Thêm productID để loại trừ sản phẩm hiện tại
